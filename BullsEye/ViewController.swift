...
//  BullsEye
//
//  Created by xin jie on 25/10/18.
...
class ViewController: UIViewController {
    ...
    @IBAction func showAlert(){
        ...
        let  differenct = abs(currentValue - targetValue)
        var points = 100 - differenct
        ...
        if differenct == 0 {
            title = "Perfect!"
            points += 100
        }else if differenct <= 5{
            title = "You almost had it!"
            if differenct == 1{
                points += 50
            }
        }else if differenct < 10 {
            title = "Pretty good!"
        }else{
